...
export class NavBar extends LitElement {
  ...
  render() {
    return html`
      ...
      <nav
        class=${`fixed top-0 left-0 h-screen w-100 bg-gray-800 text-white flex flex-col gap-6 p-6 shadow-xl z-50 transform transition-transform duration-300 ease-in-out ${this._menuOpen ? 'translate-x-0' : '-translate-x-full'}`}
      >
        <button
